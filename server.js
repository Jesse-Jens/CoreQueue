...
function getMailConfig() {
  ...
  if (process.env.SHARED_MAILBOX_UPN) cfg.address = process.env.SHARED_MAILBOX_UPN;
  if (process.env.TENANT_ID) cfg.tenantId = process.env.TENANT_ID;
  if (process.env.CLIENT_ID) cfg.clientId = process.env.CLIENT_ID;
  if (process.env.CLIENT_SECRET) cfg.clientSecret = process.env.CLIENT_SECRET;
  if (process.env.GRAPH_API) cfg.graphApi = process.env.GRAPH_API;
  if (process.env.TOKEN_ENDPOINT) cfg.tokenEndpoint = process.env.TOKEN_ENDPOINT;
  return cfg;
}
