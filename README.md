...
All other users are created by inviting contacts under an organisation. Each invite may specify a password or generate one automatically, which can then be shared with the recipient.
